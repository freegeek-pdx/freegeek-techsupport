...
"""
    ...
    for dirname in dirnames:
        ...
        print '%12s DIR %5d/%-5d %s' % (format_bytesize(total_size),dir_count, file_count, dirname)
...
def print_total(path):
    """Prints grand total of bytes.
"""
    grand_total = 0
    (dirnames, filenames_and_sizes) = dir_and_filenames(path)
    ...
    # And the grand total.
    print format_bytesize(grand_total)


if __name__ == '__main__':
    print_total(sys.argv[1])
